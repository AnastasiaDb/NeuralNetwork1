      ...
      //  BaseNetwork net = null;
        ...
        private async Task<double> train_networkAsync(int training_size, int epoches, double acceptable_error, bool parallel = true)
        {
           ...
           // pictureBox1.Enabled = false;
            ...
            SamplesSet learnImages = new SamplesSet();

            learnImages = generator.learnImages;
            ...
            {
                var curNet = Net;
                double f = await Task.Run(() => curNet.TrainOnDataSet(learnImages, epoches, acceptable_error, parallel));
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (structure.Length < 2 || structure[structure.Length - 1] != generator.figure_count)
            {
